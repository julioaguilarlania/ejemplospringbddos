...
INSERT INTO USUARIOS(LOGIN,PASSWORD,ACTIVO,FECHA_REGISTRO) VALUES ('admin','{bcrypt}$2a$10$0n7JoNym1SPKuAAK2d5u/eb3j4fN5SXIX7eFIrsqCEFoEAauf.E5.',TRUE,'2022-12-01');
INSERT INTO USUARIOS(LOGIN,PASSWORD,ACTIVO,FECHA_REGISTRO) VALUES ('user1','{bcrypt}$2a$10$Gh1UYe7djp9OufkGXymnme0GxYwlbVZJ/KTr/rOSjrIpcgK/p8vmi',TRUE,'2022-01-04');
INSERT INTO USUARIOS(LOGIN,PASSWORD,ACTIVO,FECHA_REGISTRO) VALUES ('user2','{bcrypt}$2a$10$AR2bksSZpkLvsRSGJ3up5O7bWc4Bym5uZ8t1UGREZIEkfq26VQV12',TRUE,'2022-01-05');
INSERT INTO USUARIOS(LOGIN,PASSWORD,ACTIVO,FECHA_REGISTRO) VALUES ('user3','{bcrypt}$2a$10$9cHQOrIGLnmMIr.MSZ/TWu6I2S.XAm1ycuctOGA7DCfJH013N34P2',TRUE,'2022-01-05');

INSERT INTO USUARIOS_ROLES(LOGIN,ROL) VALUES('admin','ADMINISTRADOR');
INSERT INTO USUARIOS_ROLES(LOGIN,ROL) VALUES('admin','USUARIO');
INSERT INTO USUARIOS_ROLES(LOGIN,ROL) VALUES('user1','USUARIO');
INSERT INTO USUARIOS_ROLES(LOGIN,ROL) VALUES('user1','REGISTRO_ENTRADAS');
INSERT INTO USUARIOS_ROLES(LOGIN,ROL) VALUES('user2','USUARIO');
INSERT INTO USUARIOS_ROLES(LOGIN,ROL) VALUES('user3','USUARIO');
